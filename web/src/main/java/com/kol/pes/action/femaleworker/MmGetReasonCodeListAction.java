...
public class MmGetReasonCodeListAction extends ParentAction {
	...
	@Override
	@Action(value="/get_reason_code_list_4f", results={
	...
	public String execute() throws Exception {
		this.reasonCodeList = seqService.getReasonCodeList();
