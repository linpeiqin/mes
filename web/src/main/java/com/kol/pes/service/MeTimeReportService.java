...
public interface MeTimeReportService {
	
	public DataMeTimeReportDescInfoAndActiveListInfo timeReportGetDescInfoWhenStart(String assetCode, String schedDate, String reportType, String wipId, String staffNo, String workClassCode, String opCode);
