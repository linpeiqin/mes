...
//		int day = calendar.get(Calendar.DATE);
	...
	public Calendar getTimeCal() {
		...
		LogUtils.e("WheelMain", "getTime()="+getTime()+"wv_month.getCurrentItem()="+wv_month.getCurrentItem());
		...
		LogUtils.e("WheelMain", "getTimeCal():cal="+StringUtils.formatDateTime(cal));
