...
public class MeGetDescInfoWhenSeqSelectedParser extends DefaultBasicParser<MeGetDescInfoWhenSeqSelectedAdapter> {
	...
	public MeGetDescInfoWhenSeqSelectedParser(MeGetDescInfoWhenSeqSelectedAdapter adapter){
